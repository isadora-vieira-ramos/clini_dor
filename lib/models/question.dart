...
class Question {
  ...
  static List<Question> getQuestions() {
    ...
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Utiliza hipnóticos?", options: ["Zolpidem"], questionType: QuestionType.medicine));    
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Utiliza antipsicóticos?", options: [], questionType: QuestionType.medicine));   
    ...
    options: [
      ...
      "7, 8 ou 9",
      "10 ou mais"
    ], questionType: QuestionType.closed, dependantOnQuestions: {16: "Mensalmente ou menos,2 a 4 vezes por mês, 2 a 4 vezes por semana, 4 ou mais vezes por semana"}));
    ...
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Toma as medicações no horário estabelecido?", options: ["Sim","Não"], questionType: QuestionType.closed, dependantOnQuestions: {20: "Sim"}));
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Toma todas as doses indicadas?", options: ["Sim","Não"], questionType: QuestionType.closed, dependantOnQuestions: {20: "Sim"}));    
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Vai as consultas marcadas?", options: ["Sim","Não"], questionType: QuestionType.closed, dependantOnQuestions: {20: "Sim"}));    
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Realiza os exercícios físicos indicados?", options: ["Sim","Não"], questionType: QuestionType.closed, dependantOnQuestions: {20: "Sim"}));    
    ...
    options: [
      ...
      "Semanalmente", 
      "Todos ou quase todos os dias"
    ], questionType: QuestionType.closed, dependantOnQuestions: {25: "front_center_forehead, front_left_jaw, front_right_jaw", 26: "back_head"}));
    ...
    options: ["Sim", "Não"], questionType: QuestionType.closed, dependantOnQuestions: {25: "front_center_forehead, front_left_jaw, front_right_jaw", 26: "back_head"}));
    ...
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. A dor piora ao repouso?", options: ["Sim", "Não"], questionType: QuestionType.closed, dependantOnQuestions: {42: "Sim"}));
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Há rigidez nas articulações?", options: ["Sim", "Não"], questionType: QuestionType.closed, dependantOnQuestions: {42: "Sim"}));
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. As articulações apresentam edema?", options: ["Sim", "Não"], questionType: QuestionType.closed, dependantOnQuestions: {42: "Sim"}));
    ...
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Avalie a dificuldade em pegar no sono", options: ["Nenhuma", "Leve", "Moderada", "Grave", "Muito Grave"], questionType: QuestionType.closed));
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. Avalie a dificuldade em manter o sono", options: ["Nenhuma", "Leve", "Moderada", "Grave", "Muito Grave"], questionType: QuestionType.closed));
    ...
    questionList.add(Question(id: questionList.length + 1, questionText: "${questionList.length + 1}. De 0 a 10, informe qual a expectativa de melhora com relação ao tratamento.", options: ["Melhorar", "Ficar curado(a)"], questionType: QuestionType.closed));
